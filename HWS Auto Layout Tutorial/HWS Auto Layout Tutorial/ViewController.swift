...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Challenege: add a bar button item that shows their score when tapped
        askQuestion()
    ...
    @objc func showScore(action: UIAlertAction! = nil){
        let showScorePopup = UIAlertController(title: "Your score", message: "Your score is \(score)", preferredStyle: .alert)
        showScorePopup.addAction(UIAlertAction(title: "Thanks", style: .cancel, handler: showScore))
        present(showScorePopup, animated: true)
    }
